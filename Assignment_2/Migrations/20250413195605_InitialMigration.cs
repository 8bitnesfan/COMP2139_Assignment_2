        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "integer", nullable: false),
                    ProductId = table.Column<int>(type: "integer", nullable: false),
                    OrderViewModelOrderId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProducts_Orders_OrderViewModelOrderId",
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoriesCategoryId", "CategoryId", "Description", "LowStockThreshold", "Name", "Price", "QuantityInStock", "Selected" },
                values: new object[,]
                {
                    { 1, 0, 1, "Gaming laptop", 2, "Laptop", 1500m, 10, false },
                    { 2, 0, 2, "Cotton t-shirt", 10, "T-shirt", 20m, 50, false }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_OrderViewModelOrderId",
                table: "OrderProducts",
